...
export function CategoryColorScaleBar({
  height = 10,
  className,
  colors = COLOR_OPTIONS[PRODUCTLEGENDS[PRODUCT.AUSTEMP_HEATWAVE_MCS_CATEGORY].colorKey],
  scales = PRODUCTLEGENDS[PRODUCT.AUSTEMP_HEATWAVE_MCS_CATEGORY].scales as string[],
  label,
