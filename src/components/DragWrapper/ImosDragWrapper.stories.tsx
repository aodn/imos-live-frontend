...
export const MultipleCards: Story = {
  ...
  render: args => (
    <div>
      <ImosDragWrapper {...args} initialPosition={{ x: 50, y: 50 }}>
        <SimpleCard
          title="Card 1"
      ...
      <ImosDragWrapper {...args} initialPosition={{ x: 400, y: 100 }}>
        <SimpleCard
          title="Card 2"
      ...
      <ImosDragWrapper {...args} initialPosition={{ x: 200, y: 250 }}>
        <SimpleCard
          title="Card 3"
  ...
  render: args => {
    ...
    return (
      <div>
        ...
        <ImosDragWrapper {...args} isPositionReset={isReset}>
