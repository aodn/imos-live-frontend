...
test.beforeEach(async ({ page }) => {
  ...
  await page.route(
    '/api/v1/ogc/collections/b299cdcd-3dee-48aa-abdd-e0fcdbb9cadc/items/wave_buoy_first_data_available?datetime=2025-07-02T00:00:00.000000000Z',
    async route => {
      const buoyLocations = {
  ...
  await page.route(
    '/api/v1/ogc/collections/b299cdcd-3dee-48aa-abdd-e0fcdbb9cadc/items/wave_buoy_first_data_available?datetime=2025-07-03T00:00:00.000000000Z',
    async route => {
      const buoyLocations = {
        type: 'FeatureCollection',
        metadata: {},
